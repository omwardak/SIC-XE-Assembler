...
void sicxe_asm::process_WORD(string operand, int line) {
    if(operand[0] == '$') { //Operand is a hex value
        ...
        storage[line-1].machine_code = atoi(operand.substr(0).c_str());
    }
}
